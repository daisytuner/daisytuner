...
from daisytuner.profiling.metrics.arm64fx import BranchMispredictionRatio
...
def test_branching():
    ...
    metric_static = BranchMispredictionRatio(sdfg_static, hostname="ault28.cscs.ch")
    ...
    metric_dynamic = BranchMispredictionRatio(sdfg_dynamic, hostname="ault28.cscs.ch")
