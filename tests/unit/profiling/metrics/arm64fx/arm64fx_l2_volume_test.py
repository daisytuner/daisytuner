...
from daisytuner.profiling.metrics.arm64fx import L2Volume
...
def test_indirect_copy():
    ...
    metric_linear = L2Volume(sdfg_linear, hostname="ault28.cscs.ch")
    ...
    assert value_linear < 5.0

    metric_random = L2Volume(sdfg_random, hostname="ault28.cscs.ch")
