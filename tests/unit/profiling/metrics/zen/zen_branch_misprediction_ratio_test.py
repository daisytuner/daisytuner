...
from daisytuner.profiling.metrics.zen import BranchMispredictionRatio
...
def test_branching():
    ...
    metric_static = BranchMispredictionRatio(
        sdfg_static, hostname="lukas-TUF-Gaming-FX505DV-FX505DV"
    )
    ...
    assert value_static < 0.07

    metric_dynamic = BranchMispredictionRatio(
        sdfg_dynamic, hostname="lukas-TUF-Gaming-FX505DV-FX505DV"
    )
