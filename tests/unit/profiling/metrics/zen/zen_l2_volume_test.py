...
from daisytuner.profiling.metrics.zen import L2Volume
...
def test_indirect_copy():
    ...
    metric_linear = L2Volume(sdfg_linear, hostname="lukas-TUF-Gaming-FX505DV-FX505DV")
    ...
    assert value_linear < 1.6

    metric_random = L2Volume(sdfg_random, hostname="lukas-TUF-Gaming-FX505DV-FX505DV")
