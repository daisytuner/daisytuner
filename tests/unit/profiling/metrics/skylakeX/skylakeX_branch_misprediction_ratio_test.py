...
from daisytuner.profiling.metrics.skylakeX import BranchMispredictionRatio
...
def test_branching():
    ...
    metric_static = BranchMispredictionRatio(sdfg_static, hostname="ault01.cscs.ch")
    ...
    metric_dynamic = BranchMispredictionRatio(sdfg_dynamic, hostname="ault01.cscs.ch")
