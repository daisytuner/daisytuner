...
from daisytuner.profiling.metrics.haswellEP import BranchMispredictionRatio
...
def test_branching():
    ...
    metric_static = BranchMispredictionRatio(sdfg_static, hostname="garbenheim")
    ...
    assert value_static < 0.02

    metric_dynamic = BranchMispredictionRatio(sdfg_dynamic, hostname="garbenheim")
