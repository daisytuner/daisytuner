...
from daisytuner.profiling.metrics.haswellEP import L2Volume
...
def test_indirect_copy():
    ...
    metric_linear = L2Volume(sdfg_linear, hostname="garbenheim")
    ...
    assert value_linear < 0.25

    metric_random = L2Volume(sdfg_random, hostname="garbenheim")
