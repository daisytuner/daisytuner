...
from daisytuner.profiling.metrics.zen2 import L2Volume
...
def test_indirect_copy():
    ...
    metric_linear = L2Volume(sdfg_linear, hostname="ault17.cscs.ch")
    ...
    metric_random = L2Volume(sdfg_random, hostname="ault17.cscs.ch")
