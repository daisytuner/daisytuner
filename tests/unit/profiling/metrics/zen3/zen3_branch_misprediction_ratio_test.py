...
from daisytuner.profiling.metrics.zen3 import BranchMispredictionRatio
...
def test_branching():
    ...
    metric_static = BranchMispredictionRatio(sdfg_static, hostname="lukas-Nitro")
    ...
    metric_dynamic = BranchMispredictionRatio(sdfg_dynamic, hostname="lukas-Nitro")
