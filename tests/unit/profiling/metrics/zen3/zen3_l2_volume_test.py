...
from daisytuner.profiling.metrics.zen3 import L2Volume
...
def test_indirect_copy():
    ...
    metric_linear = L2Volume(sdfg_linear, hostname="lukas-Nitro")
    ...
    metric_random = L2Volume(sdfg_random, hostname="lukas-Nitro")
