...
from daisytuner.profiling.metrics.broadwellEP import BranchMispredictionRatio
...
def test_branching():
    ...
    metric_static = BranchMispredictionRatio(sdfg_static, hostname="ault21.cscs.ch")
    ...
    metric_dynamic = BranchMispredictionRatio(sdfg_dynamic, hostname="ault21.cscs.ch")
