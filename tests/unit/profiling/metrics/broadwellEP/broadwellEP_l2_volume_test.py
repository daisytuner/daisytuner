...
from daisytuner.profiling.metrics.broadwellEP import L2Volume
...
def test_indirect_copy():
    ...
    metric_linear = L2Volume(sdfg_linear, hostname="ault21.cscs.ch")
    ...
    metric_random = L2Volume(sdfg_random, hostname="ault21.cscs.ch")
