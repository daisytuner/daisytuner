...
from daisytuner.profiling.metrics.broadwellEP import Runtime
...
def test_copy():
    ...
    metric = Runtime(sdfg, hostname="ault21.cscs.ch")
    # args = {
    ...
    assert np.allclose(value, 0.004, atol=0.001, rtol=0.0)
