...
class TiramisuTuner(CutoutTuner):
    ...
    def tune(self, cutout: dace.SDFG, arguments: Dict = None) -> Tuple[dace.SDFG, Dict]:
        from daisy_tiramisu import SDFGWrapper, AutoScheduler
        ...
        for sched, score in tqdm(schedules):
            ...
            parsed_schedule = self._parse_schedule(cutout, sched)
        ...
        for desc, score in candidates:
            schedule_space = ScheduleSpace(cutout=cutout)
        ...
        return best_state[2], {"score": best_state[1], "schedule": best_state[0]}
