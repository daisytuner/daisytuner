...
model_path = (
    Path(__file__).parent.parent / "hier_LSTM_fusion_tree_tagLo_transfer_5bl.pkl"
)
...
with torch.no_grad():
    ...
    model = Model_hier_LSTM(
        input_size, output_size, hidden_sizes=layers_sizes, drops=drops
    )
